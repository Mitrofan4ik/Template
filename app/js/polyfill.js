...
!(function(a, b, c) {
  ...
  function i(a) {
    return this instanceof i
      ? ((this._options = a),
        a.keywords || (this._options = { keywords: a }),
        (this._promise = []),
  ...
  var j = RegExp(
    ...
    k = (function() {
      ...
      return function(b) {
        var d =
          (!c.test(b) && !a) ||
          b.replace(RegExp.$1, "").split("/")[0] === location.host;
        return d;
      };
    })(),
    l = {
    ...
    m = (function() {
      ...
      function d(a) {
        l++,
          ...
          (m.onreadystatechange = function() {
            4 != m.readyState ||
              (200 != m.status && 304 != m.status) ||
              ((i[a] = m.responseText), j.shift(), c());
          }),
          m.send(null);
      }
      function f(a) {
      ...
      return {
        request: function(a, d) {
          k.push({ urls: a, fn: d }), f(a) ? g() : (b(a), c());
        },
        clearCache: function() {
          i = {};
        },
    ...
    n = {
      ...
      parse: function(a, b) {
        ...
        function j() {
          if ("/" == a[0] && "*" == a[1]) {
            for (var b = 2; "*" != a[b] || "/" != a[b + 1]; ) ++b;
            b += 2;
            var c = a.slice(2, b - 2);
            return (a = a.slice(b)), h(), { comment: c };
          }
        }
        function k() {
          var a = g(/^([^{]+)/);
        ...
        function l() {
          ...
          if (a && ((a = a[0]), g(/^:\s*/))) {
            ...
            if (b)
              return (b = d(b[0])), g(/^[;\s]*/), { property: a, value: b };
          }
        }
        function m() {
          for (var a, b = []; (a = g(/^(from|to|\d+%|\.\d+%|\d+\.\d+%)\s*/)); )
            b.push(a[1]), g(/^,\s*/);
          return b.length ? { values: b, declarations: x() } : void 0;
        }
        function o() {
          var a = g(/^@([\-\w]+)?keyframes */);
          if (a) {
        ...
        function p() {
          ...
          if (a) {
            ...
            if (c()) {
              i();
              var h = f();
              if (e()) return { supports: b, rules: h };
            }
          }
        }
        function q() {
        ...
        function r() {
          ...
          if (a) {
            ...
            if (c()) {
              ...
              if (e()) return { type: "page", selectors: b, declarations: d };
            }
          }
        }
        function s() {
        ...
        function z() {
          var a = k();
          if (a) return i(), { selectors: a, declarations: x() };
        }
        return b && n._cache[b]
          ? n._cache[b]
          : ((a = a.replace(/\/\*[\s\S]*?\*\//g, "")), (n._cache[b] = f()));
      },
      filter: function(a, b) {
        function c(a, b) {
        ...
        function f(a, b) {
          if (b)
            for (var c = b.length; c--; ) if (a.indexOf(b[c]) >= 0) return !0;
        }
        function g(a, b) {
        ...
        function h(a, c, d) {
          return b.selectors && f(a.selectors.join(","), b.selectors)
            ? (e({
                media: c,
                supports: d,
        ...
        function j(a, b, d) {
          for (var e, f = 0; (e = a[f++]); )
            e.declarations
              ? h(e, b, d) || i(e, b, d)
              : e.rules && e.media
                ? j(e.rules, c(b, e.media), d)
                : e.rules && e.supports && j(e.rules, b, c(d, e.supports));
        }
        var k = [];
        return j(a), k;
      }
    ...
    o = (function() {
      ...
      function e(a) {
        var d,
          ...
          f = !1;
        return (
          (g = b.documentElement.clientWidth),
          h.test(a) &&
            (d =
              "em" === RegExp.$2
      ...
      var c = (function() {
          ...
          return {
            add: function(b, c, d) {
              ...
              c.addListener(d), a.push({ polyfill: b, mql: c, fn: d });
            },
            remove: function(b) {
              for (var c, d = 0; (c = a[d++]); )
                c.polyfill === b &&
                  (c.mql.removeListener(c.fn), a.splice(--d, 1));
            }
          };
        })(),
        d = (function(b) {
            ...
            remove: function(d) {
              ...
              b.length ||
                (a.removeEventListener
                  ? a.removeEventListener("resize", c, !1)
                  : a.detachEvent && a.detachEvent("onresize", c));
            }
          };
        })([]);
      return {
          ...
          function f() {
            if (l.nativeMatchMedia)
              ...
              var i = b(
                ...
                a._options.debounceTimeout || 100
              );
              d.add(a, i);
            }
          }
  ...
  (g.prototype.each = function(a, b) {
    ...
    (i.prototype._defer = function(a, b) {
      a.call(this)
        ? b.call(this)
        : this._promise.push({ condition: a, callback: b });
    }),
    (i.prototype._resolve = function() {
      for (var a, b = 0; (a = this._promise[b]); )
        a.condition.call(this)
          ? (this._promise.splice(b, 1), a.callback.call(this))
          : b++;
    }),
      ...
      if (this._options.include) {
        for (c = this._options.include; (a = c[j++]); )
          if ((d = b.getElementById(a))) {
            if ("STYLE" === d.nodeName) {
              (i = { text: d.textContent }), l.push(i);
              continue;
            }
            if (d.media && "print" == d.media) continue;
            if (!k(d.href)) continue;
            (i = { href: d.href }), d.media && (i.media = d.media), l.push(i);
          }
      } else {
        for (
          c = this._options.exclude, f = b.getElementsByTagName("link");
          (d = f[j++]);
          ...
          d.rel &&
            ...
            !e(d.id, c) &&
            ((i = { href: d.href }), d.media && (i.media = d.media), l.push(i));
        for (h = b.getElementsByTagName("style"), j = 0; (g = h[j++]); )
          (i = { text: g.textContent }), l.push(i);
      }
      ...
      this._defer(
        ...
        function() {
          for (var a, b, c = [], d = 0; (a = this._stylesheets[d++]); )
            (b = a.media),
              b && "all" != b && "screen" != b
                ? c.push({ rules: a.rules, media: a.media })
                : (c = c.concat(a.rules));
    ...
    (i.constructors = { Ruleset: g, Rule: h }),
    (a.Polyfill = i);
})(window, document);